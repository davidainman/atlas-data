...
def other_alignments(ref_loc):
    ...
    for index, row in references.iterrows():
        ...
        if all("_zero" in x for x in S_values) and all("_zero" in x for x in A_values_not_local) and all("_zero" in x for x in P_values_not_local):
