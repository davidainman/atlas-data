...
def add_alignment(
    ...
    if (all(["_zero" in coarg for coarg in out_row[I_A].split(";")])) :
        out_row[I_A] = "ZERO"

    if (all(["_zero" in coarg for coarg in out_row[I_S].split(";")])) :
        out_row[I_S] = "ZERO"

    if (all(["_zero" in coarg for coarg in out_row[I_P].split(";")])) :
        out_row[I_P] = "ZERO"
